...
class PDFController extends Controller
{
    public function upload(Request $request)
    {
        ...
        try {
            ...
            if (explode(" ", $arr_lines[6])[0] == "ABN" || explode(" ", $arr_lines[6])[0] == "ARBN") {
                $abn_with_date = explode(" ", $arr_lines[7]);
            }
            if (explode(" ", $arr_lines[7])[0] == "ABN" || explode(" ", $arr_lines[7])[0] == "ARBN") {
                $abn_with_date = explode(" ", $arr_lines[8]);
            }
            ...
            $pdfReport = PDFReport::create([
                'quarter_ending' => Carbon::parse($quarterEnding, 'Australia/Melbourne')->format('Y-m-d'),
