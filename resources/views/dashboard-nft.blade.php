                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xxl-4">
                                <div class="border-start p-4 h-100 d-flex flex-column">
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" class="img-fluid avatar-xs rounded-circle object-fit-cover" alt="">
        ...
        <div class="swiper marketplace-swiper rounded gallery-light">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        <div class="explore-place-bid-img">
                            <img src="https://img.Bitrate.com/bitrate/images/img-3.gif" alt="" class="img-fluid card-img-top explore-img" />
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        <div class="explore-place-bid-img">
                            <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        <div class="explore-place-bid-img">
                            <img src="https://img.Bitrate.com/bitrate/images/img-4.gif" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                        ...
                        <table class="table table-borderless align-middle">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="card-body">
                <div class="swiper collection-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" height="220" class="object-fit-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
