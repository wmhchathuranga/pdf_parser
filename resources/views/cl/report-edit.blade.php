                ...
                <div class="table-responsive">
                    <table id="buttons-datatable1"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Other</td>
                                <td class="text-center">{{ $reportData['operating_details'][0]['other_c_q'] ?? '-' }}</td>
                                <td class="text-center">{{ $reportData['operating_details'][0]['other_y_t_d'] ?? '-' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Other</td>
                                <td class="text-center">{{ $reportData['investing_details'][0]['other_2_c_q'] ?? '-' }}
                                </td>
                                <td class="text-center">{{ $reportData['investing_details'][0]['other_2_y_t_d'] ?? '-' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Other</td>
                                <td class="text-center">{{ $reportData['financing_details'][0]['other_3_c_q'] ?? '-' }}
                                </td>
                                <td class="text-center">{{ $reportData['financing_details'][0]['other_3_y_t_d'] ?? '-' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $reportData['cash_details'][0]['beginning_cash_c_q'] ?? '-' }}
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['operating_cash_flow_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['operating_cash_flow_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Investing Cash Flow</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['investing_cash_flow_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['investing_cash_flow_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Financing Cash Flow</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['financing_cash_flow_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['financing_cash_flow_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Effect of Movement</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['effect_of_movement_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['cash_details'][0]['effect_of_movement_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>End Cash</td>
                                <td class="text-center">{{ $reportData['cash_details'][0]['end_cash_c_q'] ?? '-' }}</td>
                                <td class="text-center">{{ $reportData['cash_details'][0]['end_cash_y_t_d'] ?? '-' }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Bank Balance</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['bank_balance_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['bank_balance_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Call Deposits</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['call_deposits_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['call_deposits_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Bank Overdrafts</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['bank_overdrafts_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['bank_overdrafts_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Other</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['other_4_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['reconciliation_details'][0]['other_4_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $reportData['related_party_payments'][0]['aggregated_1_c_q'] ?? '-' }}</td>
                                <td class="text-center">--</td>
                            </tr>
                            <tr>
                                <td>Aggregated Payment 2</td>
                                <td class="text-center">
                                    {{ $reportData['related_party_payments'][0]['aggregated_2_c_q'] ?? '-' }}</td>
                                <td class="text-center">--</td>
                            </tr>
                            ...
                            <tr>
                                <td>Loans</td>
                                <td class="text-center">{{ $reportData['financing_facilities'][0]['loans_c_q'] ?? '-' }}
                                </td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['loans_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Credit Standby</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['credit_standby_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['credit_standby_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Other</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['other_5_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['other_5_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td>Total Financing</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['total_financing_c_q'] ?? '-' }}</td>
                                <td class="text-center">
                                    {{ $reportData['financing_facilities'][0]['total_financing_y_t_d'] ?? '-' }}</td>
                            </tr>
                            <tr>
