                ...
                <div class="card-body d-flex justify-content-end">
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-light btn-icon waves-effect"><i
                                class="mdi mdi-magnify lg"></i></button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive pb-4">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th colspan="4"></th>
                                    <th colspan="26" class="table-dark text-white">Cash Flows from Operating Activities
                                    </th>
                                    <th colspan="30" class="table-dark text-white">Cash Flows from Investing Activities
                                    </th>
                                    <th colspan="20" class="table-dark text-white">Cash Flows from Financing Activities
                                    </th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center"><a href="report" class="btn btn-sm btn-secondary">view</a>
                                    </td>
                                    <td>30 June 2023</td>
