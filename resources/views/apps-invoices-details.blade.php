                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                ...
                                <h6><span class="text-muted fw-normal">Email:</span>
                                    <span id="email">bitrate@Bitrate.com</span>
                                </h6>
                                <h6><span class="text-muted fw-normal">Website:</span> <a href="https://Bitrate.com/" class="link-primary" target="_blank" id="website">www.Bitrate.com</a></h6>
                        ...
                        <div class="border-top border-top-dashed mt-2">
                            <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Discount <small class="text-muted">(bitrate15)</small></td>
