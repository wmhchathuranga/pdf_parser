                    ...
                    <div class="card-body">
                        <div class="row g-1 mb-3">
                            <div class="col-lg-6">
                                ...
                                <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="img-fluid rounded mt-1">
                            </div>
                            <!--end col-->
                            <div class="col-lg-6">
                                <img src="https://img.Bitrate.com/bitrate/images/img-4.gif" alt="" class="img-fluid rounded mb-1">
                    ...
                    <div class="card-body">
                        <div class="row g-1 mb-3">
                            <div class="col-lg-6">
                                ...
                                <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" alt="" class="img-fluid rounded mt-1">
                            </div>
                            <!--end col-->
                            <div class="col-lg-6">
                                <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="img-fluid rounded mb-1">
                    ...
                    <div class="card-body">
                        <div class="row g-1 mb-3">
                            <div class="col-lg-6">
                                ...
                                <img src="https://img.Bitrate.com/bitrate/images/img-3.gif" alt="" class="img-fluid rounded mt-1">
                            </div>
                            <!--end col-->
                            <div class="col-lg-6">
                                <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="img-fluid rounded mb-1">
    ...
    <div class="col">
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="explore-place-bid-img overflow-hidden rounded">
                    <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="img-fluid explore-img">
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                    </div>
    ...
    <div class="col">
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="explore-place-bid-img overflow-hidden rounded">
                    <img src="https://img.Bitrate.com/bitrate/images/img-3.gif" alt="" class="img-fluid explore-img">
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                    </div>
...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="explore-place-bid-img">
                <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" alt="" class="card-img-top explore-img" />
                <div class="bg-overlay"></div>
                <div class="place-bid-btn">
                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                </div>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="explore-place-bid-img">
                <img src="https://img.Bitrate.com/bitrate/images/img-4.gif" alt="" class="card-img-top explore-img" />
                <div class="bg-overlay"></div>
                <div class="place-bid-btn">
                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                </div>
...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="card-img-top object-fit-cover" height="120">
            <div class="card-body text-center">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
