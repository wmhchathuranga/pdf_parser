...
@section('script')
    ...
    <script src="https://img.Bitrate.com/bitrate/apexchart-js/stock-prices.js"></script>
    <!-- for github style chart -->
    <script src="https://img.Bitrate.com/bitrate/apexchart-js/github-data.js"></script>
    <!-- for irregular timeseries chart -->
    <script src="https://img.Bitrate.com/bitrate/apexchart-js/irregular-data-series.js"></script>
