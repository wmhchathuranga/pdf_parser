                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="img-fluid rounded">
                                                    <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-6">
                                                    <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" alt="" class="img-fluid rounded mb-1">
                                                    <img src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="https://img.Bitrate.com/bitrate/images/img-5.gif" alt="" class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
