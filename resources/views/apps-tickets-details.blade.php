                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="hstack gap-3 flex-wrap">
                                            <div class="text-muted"><i
                                                    ...
                                                    id="ticket-client">Bitrate</span></div>
                                            <div class="vr"></div>
                        ...
                        <table class="table table-borderless align-middle mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="t-client">Bitrate</td>
                                </tr>
                                <tr>
                                    <td class="fw-medium">Project</td>
                                    <td>bitrate - Admin Dashboard</td>
                                </tr>
                                <tr>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center border border-dashed p-2 rounded">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1"><a href="javascript:void(0);"
                                    class="text-body">bitrate-admin.zip</a></h6>
                    ...
                    <div class="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1"><a href="javascript:void(0);"
                                    class="text-body">bitrate-admin.ppt</a></h6>
