...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.Bitrate.com/bitrate/images/img-3.gif" alt="" class="object-fit-cover card-img-top" height="120">
            <div class="card-body text-center">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="https://img.Bitrate.com/bitrate/images/img-1.gif" alt="" class="avatar-md rounded-circle object-fit-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.Bitrate.com/bitrate/images/img-2.gif" alt="" class="object-fit-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('build/images/users/avatar-6.jpg')}}" alt="" class="avatar-md rounded-circle object-fit-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.Bitrate.com/bitrate/images/img-4.gif" alt="" class="object-fit-cover card-img-top" height="120">
            <div class="card-body text-center">
