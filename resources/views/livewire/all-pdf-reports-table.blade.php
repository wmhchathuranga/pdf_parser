                                ...
                                @if ($allReports != null)
                                    @foreach ($allReports as $report)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                {{ $report['operating_details'][0]['interest_paid_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                {{ $report['financing_details'][0]['dividends_paid_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['beginning_cash_y_t_d'] ?? '-' }}</td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['operating_cash_flow_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['operating_cash_flow_y_t_d'] ?? '-' }}
                                            </td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['investing_cash_flow_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['investing_cash_flow_y_t_d'] ?? '-' }}
                                            </td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['financing_cash_flow_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['financing_cash_flow_y_t_d'] ?? '-' }}
                                            </td>
                                            <td class="text-end">
                                                {{ $report['cash_details'][0]['effect_of_movement_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                {{ $report['reconciliation_details'][0]['other_4_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                {{ $report['financing_facilities'][0]['loans_y_t_d'] ?? '-' }}</td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                {{ $report['financing_facilities'][0]['other_5_c_q'] ?? '-' }}</td>
                                            <td class="text-end">
                                                {{ $report['financing_facilities'][0]['other_5_y_t_d'] ?? '-' }}</td>
                                            <td class="text-end">
