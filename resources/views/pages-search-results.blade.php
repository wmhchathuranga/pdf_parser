                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            <div class="pb-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">bitrate - Responsive Bootstrap 5
                                        Admin Dashboard</a></h5>
                                <p class="text-success mb-2">https://Bitrate.com/bitrate/index.html</p>
                                <p class="text-muted mb-2">bitrate admin is super flexible, powerful, clean, modern &
                                    ...
                                    design in your existing project using bitrate it is very quick and easy as it is
                                    ...
                                    <li class="list-inline-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 fs-13 ms-1">
                                                <span class="fw-medium">Bitrate</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard
                                        Template</a></h5>
                                <p class="text-success mb-2">https://Bitrate.com/minia/react/</p>
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Doson - Angular Admin & Dashboard
                                        Template by Bitrate</a></h5>
                                <p class="text-success mb-2">https://Bitrate.com/dason/angular/</p>
                                ...
                                <div class="col-lg-12 video-list">
                                    <div class="list-element">
                                        <h5 class="mb-1"><a href="javascript:void(0);">Admin dashboard templates
                                                - Material Design for bitrate</a></h5>
                                        <p class="text-success">https://Bitrate.com/bitrate/index.html</p>
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                                                <p class="text-muted mb-0">bitrate admin is super flexible, powerful, clean,
                                                    ...
                                                    large projects or update design in your existing project using bitrate it
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="mb-1"><a href="javascript:void(0);">bitrate - The Most Popular
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="mb-1"><a href="javascript:void(0);">bitrate Admin Dashboard
