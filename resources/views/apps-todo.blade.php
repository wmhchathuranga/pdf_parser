        ...
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="px-4 mx-n4" data-simplebar style="height: calc(100vh - 468px);">
                <ul class="to-do-menu list-unstyled" id="projectlist-data">
                    <li>
                        <a data-bs-toggle="collapse" href="#bitrateAdmin" class="nav-link fs-14 active">bitrate Admin & Dashboard</a>
                        <div class="collapse show" id="bitrateAdmin">
    ...
    <div class="file-manager-content w-100 p-4 pb-0">
        <div class="row mb-4">
            ...
            <div class="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                <h5 class="fw-semibold mb-0">bitrate Admin & Dashboard <span class="badge bg-primary align-bottom ms-2">v2.0.0</span></h5>
            </div>
