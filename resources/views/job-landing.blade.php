                        ...
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            <div class="card p-3 rounded shadow-lg inquiry-box">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h5 class="fs-15 lh-base mb-0">Work Inquiry from bitrate</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card shadow-none">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-0 fs-15">Search for your dream jobs from bitrate.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <ul class="list-inline text-muted mb-3">
                                            <li class="list-inline-item">
                                                <i class="ri-building-line align-bottom me-1"></i> Bitrate
                                            </li>
                                            <li class="list-inline-item">
                                                <i class="ri-map-pin-2-line align-bottom me-1"></i> USA
                                            </li>
