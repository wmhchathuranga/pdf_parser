                ...
                <div class="p-2">
                    ...
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                            ...
                            United States</div>
                        <div><i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>Bitrate
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">daveadame@bitrate.com</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="#" class="fw-semibold">www.bitrate.com</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                ...
                                <div class="acitivity-timeline">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-2">added a new member to bitrate
                                                dashboard</p>
                                        ...
                                        <div class="card profile-project-card profile-project-primary">
                                            <div class="card-body p-4">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                                        <h5 class="fs-14 text-truncate"><a href="#"
                                                                class="text-body">bitrate Project</a>
                                                        </h5>
                                                        <p class="text-muted text-truncate mb-0">Last
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ms-3 flex-grow-1">
                                                                    <h6 class="fs-15 mb-0"><a
                                                                            href="javascript:void(0);">bitrate-logo.png</a>
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                        </td>
