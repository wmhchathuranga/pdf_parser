                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to bitrate.</p>
                            </div>
                            <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'admin@Bitrate.com')); ?>" id="username" name="email" placeholder="Enter username">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> bitrate. Crafted with <i class="mdi mdi-heart text-danger"></i> by Bitrate</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Laravel\pdf_extract\resources\views/auth/login.blade.php ENDPATH**/ ?>